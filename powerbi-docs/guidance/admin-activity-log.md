...
- De gebruiker van het PowerShell-script moet zich aanmelden met de [cmdlet Connect-PowerBIServiceAccount](/powershell/module/microsoftpowerbimgmt.profile/connect-powerbiserviceaccount), en moet Power BI-beheerdersreferenties invoeren wanneer hierom wordt gevraagd. Beheerdersbevoegdheden zijn vereist voor het gebruik van de Activiteitenlogboek-API.

> [!IMPORTANT]
> Gebruikers zonder beheerdersbevoegdheden kunnen geen codefragmenten uit het voorbeeldscript uitvoeren.
