...
Klaar om uw klassieke werkruimte te migreren? Zie [Een upgrade uitvoeren van de klassieke werkruimten naar de nieuwe werkruimten in Power BI](designer/service-upgrade-workspaces.md) voor meer informatie.
