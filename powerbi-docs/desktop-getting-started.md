...
![Power BI Desktop uit Power BI-service downloaden](media/desktop-getting-started/gsg_download.png)
...
![Welkomstscherm Power BI Desktop](media/desktop-getting-started/designer_gsg_startsplashscreen.png)
...
![De pictogrammen voor de drie weergaven van Power BI Desktop](media/desktop-getting-started/designer_gsg_viewtypes.png)

De standaardweergave is **Rapport**. 

![De rapportweergave in Power BI Desktop](media/desktop-getting-started/designer_gsg_blankreport.png)
...
![Webgegevensbron selecteren](media/desktop-getting-started/gsg_syw_2.png)
...
![Webadres plakken in het dialoogvenster Van web](media/desktop-getting-started/gettingstarted_8.png)
...
![Tabelvoorbeeld van webpagina](media/desktop-getting-started/datasources_fromnavigatordialog.png)
...
![Power Query-editor met queryinstellingen](media/desktop-getting-started/designer_gsg_editquery.png)
...
![Het deelvenster Queryinstellingen met drie toegepaste stappen](media/desktop-getting-started/designer_gsg_appliedsteps_changedtype.png)
...
![Gegevenstype wijzigen](media/desktop-getting-started/designer_gsg_changedatatype.png)
...
![Rijen oplopend sorteren](media/desktop-getting-started/shapecombine-changetype-b.png)
...
![Onderste rijen verwijderen](media/desktop-getting-started/pbi_gsg_getdata3.png)
...
![Kolommen verwijderen](media/desktop-getting-started/pbi_gsg_getdata3a.png)
...
![Toegepaste stappen wijzigen](media/desktop-getting-started/designer_gsg_install.png)
...
![Waarschuwing bij stap verwijderen](media/desktop-getting-started/deletestepwarning.png)
...
![Voltooide query](media/desktop-getting-started/shapecombine_querysettingsfinished.png)

Zie [Gegevens vormgeven en combineren in Power BI Desktop](desktop-shape-and-combine-data.md) voor meer informatie over het vormgeven van gegevens.
...
![Nieuwe bron](media/desktop-getting-started/pbi_gettingstartedsplash_resized.png)
...
![Rijen filteren](media/desktop-getting-started/filterrows.png)
...
![Vormgegeven tabel met codes voor staten](media/desktop-getting-started/statecodes.png)
...
![Query's samenvoegen](media/desktop-getting-started/shapecombine_merge.png)
...
![Kolom Samengevoegde query](media/desktop-getting-started/mergedquery.png)
...
![Uitgevouwen kolom kiezen in samengevoegde tabel](media/desktop-getting-started/shapecombine_mergeexpand.png)
...
Zie [Gegevens vormgeven en combineren in Power BI Desktop](desktop-shape-and-combine-data.md) voor een gedetailleerde beschrijving van de stappen voor het vormgeven en combineren van gegevens.
...
![Vormgegeven en gecombineerde query's](media/desktop-getting-started/mergedcolumn.png)
...
![Sluiten en wijzigingen toepassen](media/desktop-getting-started/shapecombine_closeandapply.png)
...
![De rapportweergave in Power BI Desktop](media/desktop-getting-started/designer_gsg_reportview.png)
...
![Deelvensters uitvouwen of samenvouwen](media/desktop-getting-started/designer_gsg_collapsepanes.png)
...
![Veld Staten slepen om een kaartvisualisatie te maken](media/desktop-getting-started/designer_gsg_reportfirstdrag.png)
...
![Het deelvenster Visualisatie](media/desktop-getting-started/designer_gsg_visualizationtypes.png)
...
![De filter Top 10 van het weer](media/desktop-getting-started/gsg_share5.png)
...
![Titel wijzigen](media/desktop-getting-started/designer_gsg_report1.png)
...
![Een kolomdiagram visualiseren](media/desktop-getting-started/gsg_share7.png)
...
![Oplopend sorteren](media/desktop-getting-started/shapecombine_mergequeries.png)
...
![Voltooid kolomdiagram](media/desktop-getting-started/shapecombine_changetype.png)
...
![Visualisaties in de vorm van tabellen, lijndiagrammen en gegroepeerde kolomdiagrammen](media/desktop-getting-started/designer_gsg_report2costofliving.png)
...
![Paginabalk](media/desktop-getting-started/pages.png)
...
![Pagina Voltooid Power BI Desktop-rapport](media/desktop-getting-started/finished-report.png)

Zie [Rapportweergave in Power BI Desktop](desktop-report-view.md) voor meer informatie over rapporten.
...
![Publiceren selecteren](media/desktop-getting-started/gsg_syw_1.png)
...
![Publiceren Power BI geslaagd](media/desktop-getting-started/gsg_syw_3.png)
...
![Gegevens ophalen op Power BI-startpagina selecteren](media/desktop-getting-started/pbi_gsg_getdata1.png)

Selecteer op de volgende pagina de optie **Ophalen** in de sectie **Bestanden**.

![Bestanden ophalen](media/desktop-getting-started/pbi_gsg_getdata2.png)
...
![Power BI Desktop-bestand in Power BI geïmporteerd](media/desktop-getting-started/pbi_gsg_getdata4.png)
...
![Een rapport bewerken en Een kopie opslaan](media/desktop-getting-started/gsg_share4.png)

U kunt allerlei interessante visuals maken vanuit uw rapport in de **Power BI**-service, die u aan een *dashboard* kunt vastmaken. Als u meer informatie wilt over dashboards in de **Power BI**-service, bekijkt u [Tips voor het ontwerpen van een geweldig dashboard](service-dashboards-design-tips.md). Zie [Een dashboard delen](service-share-dashboards.md) voor meer informatie over het maken, delen en wijzigen van dashboards.
...
![Rapport delen](media/desktop-getting-started/gsg_share6.png)
