...
description: Meer informatie over gepagineerde rapporten in de Power BI-service en de regels voor het bepalen van de paginering om een rapport te ontwerpen dat geoptimaliseerd is voor de renderer die u wilt gebruiken.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: ''
ms.service: powerbi
