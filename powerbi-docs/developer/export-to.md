...
ms.locfileid: "78264192"
---
# <a name="export-report-to-file-preview"></a>Rapport exporteren naar bestand (preview)
...
U kunt alleen verifiëren met behulp van een gebruiker (of hoofdgebruiker). [Service-principal](embed-service-principal.md) wordt momenteel niet ondersteund.
...
* Het rapport dat u wilt exporteren, moet zich in een capaciteit bevinden.
* De gegevensset van het rapport dat u wilt exporteren, moet zich in een capaciteit bevinden.
...
* [Service-principal](embed-service-principal.md) wordt niet ondersteund.
...
* [Persoonlijke bladwijzers](../consumer/end-user-bookmarks.md#personal-bookmarks) en [permanente filters](https://powerbi.microsoft.com/blog/announcing-persistent-filters-in-the-service/) worden niet ondersteund
* Gepagineerde rapporten worden momenteel niet ondersteund.
