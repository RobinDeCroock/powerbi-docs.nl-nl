...
- Deze zelfstudie is bedoeld voor Power BI-gebruikers die al bekend zijn met het gebruik van Power BI Desktop en eraan toe zijn om geavanceerdere modellen te maken. U weet waarschijnlijk al hoe u met Gegevens ophalen en de Power Query-editor gegevens kunt importeren, kunt werken met meerdere gerelateerde tabellen en velden kunt toevoegen aan het rapportcanvas. Raadpleeg [Aan de slag met Power BI Desktop](desktop-getting-started.md) als u nog geen ervaring hebt met het gebruik van Power BI Desktop.
