...
description: Informatie over het beheren van de on-premises gegevensgateway en de SQL Server-gegevensbronnen die deel uitmaken van deze gateway.
author: arthiriyer
ms.author: arthii
ms.reviewer: ''
ms.service: powerbi
