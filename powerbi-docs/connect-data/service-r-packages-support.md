...
Ondersteunde R-pakketten voor de **Power BI-service** vindt u in de volgende sectie, met de naam **Ondersteunde pakketten**. Als u ondersteuning wilt aanvragen voor een R-pakket dat niet in de lijst staat, dient u een aanvraag in op [Power BI Ideas](https://ideas.powerbi.com).
