...
U kunt lezen over welke gegevens worden overgebracht naar ESRI in hun [documentatie](https://doc.arcgis.com/en/maps-for-powerbi/get-started/data-transfer.htm).
