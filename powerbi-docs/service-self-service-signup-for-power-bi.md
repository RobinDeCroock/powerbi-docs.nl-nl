...
1. Op dit punt moet u mogelijk wachten, indien Microsoft [een nieuwe tenant instelt](service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md). Zo niet, dan wordt de Power BI-service in uw browser geopend.
