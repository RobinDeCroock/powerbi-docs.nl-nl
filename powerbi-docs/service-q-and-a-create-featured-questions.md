...
ms.locfileid: "65625301"
---
# <a name="create-featured-questions-for-power-bi-qa"></a>Aanbevolen vragen voor Q&A-functie van Power BI maken
Als u beschikt over een gegevensset, kunt u uw eigen aanbevolen vragen toevoegen aan deze dataset. Power BI Q & A toont deze vragen aan collega's die rapporten op basis van die gegevensset gebruiken.  Aanbevolen vragen geven uw collega's ideeën over de typen vragen die ze kunnen stellen over de gegevensset. U bepaalt zelf welke aanbevolen vragen u toevoegt: u kunt populaire vragen, vragen die interessante resultaten weergeven of vragen die mogelijk moeilijk zijn te formuleren toevoegen.


> [!NOTE]
> Q & A-aanbevolen vragen zijn beschikbaar voor gebruik in de [Microsoft Power BI-app voor iOS op iPads, iPhones en iPod Touch-apparaten](consumer/mobile/mobile-apps-ios-qna.md) en Power BI Desktop Q & A. Het maken van de vragen is alleen beschikbaar in Power BI-service (app.powerbi.com).
> 

## <a name="create-a-featured-question"></a>Maken van een aanbevolen vraag

In dit artikel wordt het [voorbeeld van een retailanalyse](sample-datasets.md) gebruikt. Volg de stapsgewijze instructies om te proberen met het verkennen van een gegevensset.
...
2. Als u wilt toevoegen aan deze lijst, selecteer het tandwielpictogram in de rechterbovenhoek van Power BI.  
...
8. Het antwoord wordt als een visualisatie met een gevulde kaart weergegeven.  
   ![Q & A aanbevolen vraag is beantwoord: kaartvisualisatie](media/service-q-and-a-create-featured-questions/power-bi-qna-featured-question.png)
