...
Wanneer u het verbeterde rapport met metrische gebruiksgegevens voor het eerst opent, wordt er automatisch een gegevensset voor het rapport voor metrische gebruiksgegevens gemaakt in Power BI. Het verbeterde rapport met metrische gebruiksgegevens is afhankelijk van die gegevensset. Power BI vernieuwt deze gegevensset vervolgens dagelijks. Hoewel u het vernieuwingsschema niet kunt wijzigen, kunt u wel de referenties bijwerken die Power BI gebruikt om de metrische gegevens over gebruik te vernieuwen. Mogelijk moet u de geplande vernieuwing hervatten als de referenties zijn verlopen of als u de gebruiker die het rapport met metrische gegevens over het gebruik voor het eerst heeft gestart, hebt verwijderd uit de werkruimte waarin de gegevensset zich bevindt.
...
| --- | --- | --- |
| Gebruik rapporteren | Rapportweergaven/rapport wordt geopend | Telkens wanneer iemand een rapport opent, wordt er een rapportweergave geregistreerd en staat dit voor een unieke landing op het rapport. Dit beantwoordt de vraag hoe vaak een rapport wordt geopend. Deze definitie van een rapportweergave verschilt van eerdere rapporten met metrische gebruiksgegevens. Het wijzigen van rapportpagina's wordt niet langer beschouwd als een extra rapportweergave. In plaats daarvan worden wijzigingen aan rapportpagina's meegerend voor de metrische gegevens over het aantal rapportpaginaweergaven. Activiteiten zoals delen en vastmaken worden niet langer in aanmerking genomen bij metrische gebruiksgegevens. |
| Gebruik rapporteren | Rapportpaginaweergaven | Telkens wanneer iemand een rapportpagina weergeeft, wordt er een rapportpaginaweergave geregistreerd. Dit betreft dus het totale aantal weergaven voor alle pagina's. Dit beantwoordt de vraag hoe vaak er rapportpagina's worden weergegeven. In plaats daarvan worden wijzigingen aan rapportpagina's meegerekend voor de metrische gegevens over het aantal rapportpaginaweergaven. Zie [Overwegingen en beperkingen](#considerations-and-limitations) voor belangrijke details. |
...
| Gebruik rapporteren | Report views per day | Het totale aantal rapportweergaven per dag. Geteld op rapportniveau. Hierbij wordt geen rekening gehouden met rapportpaginaweergaven. |
...
| Gebruik rapporteren | Pagina's | Als het rapport meer dan één pagina heeft, segmenteert u het rapport op de pagina('s) die is (zijn) weergegeven. Leeg betekent dat er binnen 24 uur nadat de nieuwe pagina wordt weer gegeven in de slicerlijst, een rapportpagina is toegevoegd of dat er rapportpagina's zijn verwijderd. 'Leeg' legt deze situaties vast. |
