...
![Diagram van de Power BI-architectuur voor het cluster Web Front End.](media/service-admin-power-bi-security/pbi_security_v2_wfe.png)
...
![Diagram van de Power BI-architectuur voor het cluster Web Back End.](media/service-admin-power-bi-security/pbi_security_v2_backend_updated.png)
...
Power BI gebruikt twee primaire opslag plaatsen voor het opslaan en beheren van gegevens: gegevens die worden geüpload van gebruikers worden doorgaans verzonden naar **Azure Blob Storage**, en alle meta gegevens en artefacten voor het systeem zelf worden opgeslagen in **Azure SQL database**.
...
Raadpleeg het [Vertrouwenscentrum van Microsoft](https://www.microsoft.com/trust-center/product-overview) voor meer informatie.
