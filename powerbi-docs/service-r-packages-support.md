...
|afbeeldingen| 3.4.1| NA|
|afbeeldingen| grDevices| party (>= 1.1-0)|
|afbeeldingen| CRAN| NA|
|grDevices| 3.4.1| NA|
...
|gridExtra (>= 2.0.0)| afbeeldingen| reshape2|
...
|rngtools (>= 1.2.3)| cluster| afbeeldingen|
...
* [R-visuals maken in de Power BI-service](visuals/service-r-visuals.md)
