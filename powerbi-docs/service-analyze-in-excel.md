...
## <a name="two-ways-to-get-started"></a>Twee manieren om aan de slag te gaan
Er zijn twee verschillende manieren om uw Power BI-gegevenssets te verkennen in Excel: als u vanuit Power BI begint, volgt u de stappen die in dit document worden beschreven.  Het is nu ook mogelijk voor gebruikers met bepaalde Office-SKU's om rechtstreeks toegang te krijgen tot de gegevenssets vanuit de ervaring met Gegevens ophalen in een Excel-werkmap.  Ze kunnen bladeren door de gegevenssets waartoe ze toegang hebben, om te zien of gegevenssets zijn gecertificeerd of gepromoveerd en of er beveiligingslabels op de gegevens zijn toegepast.  Zie [Een draaitabel maken op basis van Power BI-gegevenssets](https://support.office.com/article/31444a04-9c38-4dd7-9a45-22848c666884) in de Excel-documentatie voor meer informatie over deze ervaring.
...
* Gastgebruikers kunnen **Analyseren in Excel** niet gebruiken voor gegevenssets die zijn verzonden vanuit een andere tenant. 
...
## <a name="get-started-with-analyze-in-excel-in-power-bi"></a>Aan de slag met Analyseren in Excel in Power BI
