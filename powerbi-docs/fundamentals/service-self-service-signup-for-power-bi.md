...
![Diagram van schermopnamen van Power BI Desktop, service en mobiel en hun geïntegreerde relaties.](media/service-self-service-signup-for-power-bi/power-bi-tools.png)
...
- Selecteer **Gratis beginnen** of **Gratis proberen** op [powerbi.microsoft.com](https://powerbi.com). Mogelijk moet u twee keer een knop selecteren.
    ...
    ![Schermopname van de Power B I-service met powerbi.com in een webbrowser.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-try.png)    

- U kunt ook een e-mail met een koppeling naar een Power BI-dashboard, -rapport of -app selecteren.

    ![Schermopname van Power BI-service met een e-mail die wordt verzonden vanaf powerbi.com.](media/service-self-service-signup-for-power-bi/power-bi-email.png)

1. Microsoft 365 detecteert u en registreert dat er al een Microsoft-service voor u is geïnstalleerd. Selecteer **Aanmelden**.

    ![Schermopname van de Power BI-service waaruit blijkt dat Microsoft de e-mail herkent.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-sign-up.png)
...
1. Mogelijk wordt een van deze dialoogvensters weergegeven. 
    - Als u hierom wordt gevraagd, meldt u zich aan met het account van uw organisatie.
        ...
        ![Schermopname van Power BI-service met de vraag om een nieuw e-mailadres in te voeren.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-sign-in.png)
    ...
    - Controleer, als u een dergelijk bericht krijgt, of u een werk- of school-e-mailadres gebruikt en niet een consumentadres zoals Hotmail, Gmail of Outlook. Zie [bovenstaande ondersteunde e-mailadressen.](#supported-email-addresses)
       ...
       ![Schermopname van Power BI-service met de vraag om het e-mailadres te bevestigen.](media/service-self-service-signup-for-power-bi/power-bi-did-you.png)

    - Als u een dergelijk bericht krijgt, moet u de voorwaarden doornemen. Als u akkoord gaat, selecteert u **Start**. 

        ![Schermopname van de Power BI-service met de vraag om aan te melden voor Aan de slag.](media/service-self-service-signup-for-power-bi/power-bi-almost.png)

1. U kunt ook enkele collega's uitnodigen om met u mee te doen.

   ![Schermopname van de Power BI-service met het venster Meer personen uitnodigen.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-friends.png)    
...
1. Op dit punt moet u mogelijk wachten, indien Microsoft [een nieuwe tenant instelt](../admin/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md). Zo niet, dan wordt de Power BI-service in uw browser geopend.
    ...
    ![Schermopname van de Power BI-service met het startscherm van Power BI.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-power-bi.png)    
...
![Schermopname van de Power BI-service met het venster Power BI-proefversie.](media/service-self-service-signup-for-power-bi/power-bi-start-trial.png)
...
![Schermopname van de Power BI-service met het dialoogvenster van Power BI-proefversie.](media/service-self-service-signup-for-power-bi/power-bi-start-trial.png)
...
**Persoonlijke e-mailadressen** U probeert zich aan te melden met een persoonlijk e-mailadres (bijvoorbeeld nancy@gmail.com) en u ontvangt een bericht dat vergelijkbaar is met een van de volgende berichten: 
...
**Oplossing** Power BI biedt geen ondersteuning voor e-mailadressen van e-mailservices voor consumenten of die afkomstig zijn van telecomproviders. U kunt de registratie alsnog proberen te voltooien door een e-mailadres te gebruiken dat is toegewezen door uw werk of school. 
...
**Uw e-mailadres is geen Microsoft 365-id** U ziet bij de registratie een bericht dat vergelijkbaar is met het volgende:
...
**Oplossing** Uw organisatie gebruikt id's (die verschillen van uw e-mailadres) voor aanmelding bij Microsoft 365 en andere Microsoft-services.  Bijvoorbeeld: uw e-mailadres is zalan.bola@contoso.com, maar uw id is zalanb@contoso.com.
...
**Oplossing** Soms moet u het een paar keer proberen. Als u het wachtwoord meerdere keren hebt geprobeerd en u zich nog steeds niet kunt aanmelden, kunt u uw browser uitvoeren in de modus Incognito (Chrome) of InPrivate (Microsoft Edge).
