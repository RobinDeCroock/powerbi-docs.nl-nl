...
In deze snelstartgids wordt uitgelegd hoe u Power BI kunt gebruiken om op basis van gegevens tot zakelijke inzichten te komen. Dit artikel is niet bedoeld om uitgebreide informatie te bieden, maar is eerder een rondleiding langs de vele acties die beschikbaar zijn voor **zakelijke gebruikers** van Power BI.
...
![Schermopname waarin u ziet hoe in Power BI inhoud wordt opgehaald uit verschillende bronnen en een rapport wordt gegenereerd.](./media/end-user-reading-view/power-bi-concept.png)
...
Zelfs in de Leesweergave is de inhoud niet statisch. U kunt hier induiken voor trends, inzichten en andere business intelligence. Deel de inhoud op in fragmenten en segmenten en stel zelfs vragen in uw eigen bewoording. Of doe het rustig aan en laat uw gegevens zelf interessante inzichten voor u vinden; ontvang meldingen wanneer gegevens worden gewijzigd en krijg e-mailrapporten volgens een door u ingestelde planning. Al uw gegevens via de cloud of on-premises binnen handbereik vanaf elk apparaat, wanneer u maar wilt. 
...
![Illustratie van hetzelfde dashboard, weergegeven op een mobiele telefoon en in een computerbrowser.](./media/end-user-reading-view/power-bi-dashboard-phone.png)
...
![Pictogram Abonneren selecteren](./media/end-user-reading-view/power-bi-subscribe-and-email.png)
...
Wanneer u inhoud markeert als *Favoriet*, kunt u deze inhoud openen in het [Startscherm](end-user-home.md) en in het navigatievenster. Het navigatievenster is zichtbaar vanuit vrijwel elk gebied van de Power BI-service. Favorieten zijn doorgaans de dashboards, rapportpagina's en apps die u het vaakst bezoekt.

Als u inhoud wilt opslaan als favoriet, selecteert u het sterpictogram in de rechterbovenhoek van de Power BI-service. 
   
![Schermopname van de rechterbovenhoek van een dashboard, met het sterpictogram rood onderstreept.](./media/end-user-reading-view/power-bi-favorite-icon.png)

Als u uw favorieten wilt bekijken, selecteert u **Favorieten** in het navigatievenster.

![Schermopname van de Startpagina, met Favorieten geselecteerd en rood onderstreept.](./media/end-user-reading-view/power-bi-list-favorite.png)

Bekijk de andere acties die beschikbaar zijn in de menubalk.  Niet alle acties worden in dit artikel behandeld, maar wel in andere artikelen.  Via de Power BI-inhoudsopgave of het veld **Zoeken** kunt u meer informatie vinden over de acties. 
...
Als u de weergave wilt aanpassen, selecteert u het pictogram **Weergave** in de menubalk rechtsboven, en kiest u een van de weergaveopties. 

![het menu Rapportweergave](media/end-user-reading-view/power-bi-view-icon.png)
...
![Schermopname met een pijl die wijst naar het pictogram voor de Focusmodus.](media/end-user-reading-view/power-bi-fullscreen.png)

![Schermopname van een visual in de Focusmodus die het hele canvas vult.](media/end-user-reading-view/power-bi-fullscreen-after.png)

Als u dezelfde visualisatie wilt weergeven zonder de afleiding van menubalken, het filtervenster en dergelijke, selecteert u het **Volledig scherm** in de vervolgkeuzelijst Weergave.   

![Schermopname van het vervolgkeuzemenu voor Weergave.](media/end-user-reading-view/power-bi-focus.png)

![Schermopname van dezelfde visual in de modus Volledig scherm.](media/end-user-reading-view/power-bi-full.png)
...
Een visual in Power BI wordt opgebouwd met gegevens uit onderliggende gegevenssets. Als u een kijkje achter de schermen wilt nemen, kunt u de gegevens die zijn gebruikt voor het maken van het visuele element *weergegeven* in Power BI. Wanneer u **Weergeven als een tabel** selecteert, geeft Power BI de gegevens onder (of naast) de visualisatie weer.

Selecteer voor een actieve visual **Meer opties** (...) en kies **Een tabel weergeven**.
   
   ![Schermopname met bovenaan een vlakdiagram en een tabel met de gegevens eronder.](./media/end-user-show-data/power-bi-show-data-table.png)
...
Dit is slechts een kort overzicht van enkele dingen die *zakelijke gebruikers* met de Power BI-service kunnen doen.  
