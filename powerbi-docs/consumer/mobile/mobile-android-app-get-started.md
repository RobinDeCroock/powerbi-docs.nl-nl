...
Tik op **Favorieten** (![pictogram Favorieten](./media/mobile-android-app-get-started/power-bi-mobile-apps-home-favorites-icon.png)) op de navigatiebalk om de pagina Favorieten te openen. 
...
* [KPI's op de webportal](/sql/reporting-services/working-with-kpis-in-reporting-services) maken.
