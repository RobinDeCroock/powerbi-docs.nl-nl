...
3. Hier kunt u meldingen volledig uitschakelen of kiezen welke meldingen u wilt ontvangen.
    ...
    **Op een iPhone**
    ...
    ![Schermopname toont het scherm van een iPhone-telefoon voor Power BI waar u meldingen kunt toestaan en beheren.](./media/mobile-apps-notification-center/power-bi-notifications-iphone-settings.png)
   
    **Op een Android-telefoon**
   
    ![Schermopname toont het scherm van een Android-telefoon voor Power BI waar u meldingen kunt toestaan en beheren.](./media/mobile-apps-notification-center/power-bi-notifications-android-settings.png)

    **Op een Windows 10-apparaat**

    ![Schermopname toont het scherm van een Windows 10-apparaat voor Power BI waar u meldingen kunt toestaan en beheren.](./media/mobile-apps-notification-center/power-bi-notifications-windows10-settings.png)
