...
U hebt een Power BI Pro-licentie nodig om gegevens te exporteren of om het dashboard of rapport met u te delen met Premium-capaciteit. Zie [Welke licentie heb ik?](end-user-license.md) voor meer informatie. De auteur van het rapport heeft mogelijk het exporteren van gegevens uitgeschakeld voor een rapport. Als u gegevens niet kunt exporteren, raadpleegt u de auteur van het rapport.
