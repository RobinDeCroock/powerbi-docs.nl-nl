...
**account** Gebruik uw werk- of schoolaccount om u aan te melden bij Power BI. Beheerders beheren werk- of schoolaccounts in Azure Active Directory. Uw toegangsniveau wordt bepaald door de Power BI-licentie die is gekoppeld aan dit account en het capaciteitstype waar inhoud wordt opgeslagen. Zie **licentie** en **Premium** hieronder. 
...
**aggregation (aggregatie)** Het verminderen van het aantal rijen in onderliggende gegevensbronnen zodat ze in een model passen. Het resultaat is een aggregatie.
...
**data classification (gegevensclassificatie)** Zie Classificatie
...
**KPIs (KPI's)** Key Performance Indicators. Een type visual.
...
**Notification Center (Meldingencentrum)** De locatie in de service waar berichten aan gebruikers worden aangeboden, zoals meldingen over het instellen van bepaalde functies.
...
**permissions (machtigingen)** Wat een gebruiker wel en niet mag doen in Power BI wordt bepaald aan de hand van machtigingen. Als *consument* hebt u niet dezelfde machtigingen als een *ontwerper*, beheerder of ontwikkelaar.

**phone report (telefoonrapport)** De naam van een Power BI-rapport dat is opgemaakt voor weergave op telefoons.
...
**Q&A virtual analyst (Virtuele analist van Q&A)**  
...
**relative links (relatieve koppelingen)** Koppelingen van dashboardtegels naar andere dashboards en rapporten die rechtstreeks zijn gedeeld of gedistribueerd via een Power BI-app. Dit leidt tot uitgebreidere dashboards die ondersteuning bieden voor drillthrough.
...
## <a name="y"></a>Y
**y-axis (y-as)** De as aan de zijkant, de verticale as.
