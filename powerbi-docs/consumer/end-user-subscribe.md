...
![Pictogram Abonneren selecteren](./media/end-user-subscribe/power-bi-subscribes.png).
...
1. Selecteer **Nieuw abonnement toevoegen**.
   ...
   ![Venster Abonneren](./media/end-user-subscribe/power-bi-email-numbered.png)
    
    Het scherm aan de linkerkant wordt weergegeven wanneer u zich op de rapportpagina bevindt en u **Abonneren** selecteert. Het scherm aan de rechterkant wordt weergegeven wanneer u zich in een dashboard bevindt en u **Abonneren** selecteert. 
    
    a. Abonneren op meer dan één pagina in een rapport: selecteer **Nieuw abonnement toevoegen** en selecteer een andere pagina in de vervolgkeuzelijst bovenaan, of schakel het selectievakje **Volledige rapportbijlage als** in onder **Ook opnemen**. 
    ...
    c. Voeg ten minste één e-mailadres toe en voeg desgewenst informatie over het onderwerp en de berichttekst toe. 
    ...
    bijvoorbeeld Schakel een of meer selectievakjes in.
    - Geef ontvangers toestemming om het rapport of het dashboard te openen en weer te geven.
    - Selecteer **Ga naar rapport/dashboard** om de koppeling Naar het rapport aan de berichttekst toe te voegen.
    - Voeg een miniatuurpreview van de rapportpagina toe aan de hoofdtekst van het e-mailbericht.
    - Voeg het volledige rapport als bijlage toe in plaats van slechts één rapportpagina en selecteer PDF of PowerPoint. De grootte van de bijlage is beperkt tot maximaal twintig pagina's en is minder dan 25 MB. Voor de bijlage wordt rekening gehouden met alle privacylabels voor het rapport. 
    
    h. Selecteer **Nu uitvoeren** om uw abonnement te beoordelen en testen.  Hiermee wordt het e-mailbericht meteen naar u verzonden. 
...
3. Selecteer **Opslaan en sluiten** om het abonnement op te slaan als alles er goed uitziet. U ontvangt een e-mailbericht en een momentopname van het dashboard of rapport volgens de planning die u instelt. Voor alle abonnementen waarbij de frequentie is ingesteld op **Nadat gegevens zijn vernieuwd**, wordt alleen een e-mailbericht verzonden na de eerste geplande vernieuwing op die dag.
   ...
   ![E-mail met momentopname van dashboard](media/end-user-subscribe/power-bi-subscriptions-email.png)
   
    U kunt de rapportpagina vernieuwen, maar niet de gegevensset. Alleen de eigenaar van een gegevensset kan de gegevensset vernieuwen. Als u de naam van de eigenaar van de onderliggende gegevensset(s) wilt opzoeken, opent u het rapport en selecteert u de vervolgkeuzelijst in de menubalk.
...
![Alle abonnementen in mijn werkruimte weergeven](./media/end-user-subscribe/power-bi-manage-subscription.png)
...
* De functie voor volledige rapporten als bijlage is beschikbaar voor rapporten die voldoen aan de volgende drie voorwaarden. Bestaande abonnementen met volledige rapporten als bijlagen die niet aan deze voorwaarden voldoen, worden uitgeschakeld en u ontvangt een e-mailbericht waarin de fout wordt uitgelegd.
