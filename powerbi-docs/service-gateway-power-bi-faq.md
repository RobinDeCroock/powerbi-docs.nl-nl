...
description: Hier vindt u de veelgestelde vragen over on-premises gegevensgateways voor Power BI. Op deze centrale plek zijn alle veelgestelde vragen over de gateway die in Power BI wordt gebruikt, bij elkaar gebracht.
author: mgblythe
manager: kfile
ms.reviewer: ''
ms.service: powerbi
